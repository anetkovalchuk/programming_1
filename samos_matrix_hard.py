...
result_vector = multiply_matrix_vector(original_matrix1, vector)
...
selected_row = get_row(original_matrix1, row_number - 1)

if selected_row is not None:
    print(f"Рядок {row_number} в матриці:")
...
result_subtracted_rows = subtract_vector_from_rows(original_matrix1, vector)

if result_subtracted_rows:
    print("Результат віднімання вектора від матриці:")
    print_matrix(result_subtracted_rows)

result_upper_triangular = upper_triangular(original_matrix1)

if result_upper_triangular:
    print("Матриця в верхній трикутній формі:")
    print_matrix(result_upper_triangular)

rank_of_matrix1 = matrix_rank(original_matrix1)
print(f"Ранг матриці: {rank_of_matrix1}")


det_matrix1 = determinant(original_matrix1)
